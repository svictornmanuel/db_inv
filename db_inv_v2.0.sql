...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2025 a las 13:58:18
...
CREATE TABLE `productos` (
  ...
  `luz_solar` enum('Alta','Media','Baja') DEFAULT 'Media'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `productos` (`id_productos`, `id_categorias`, `nombre`, `descripcion`, `precio`, `luz_solar`) VALUES
(1, 2, 'Planta Piedra', 'Lithops karasmontana: especie de planta suculenta perteneciente a la familia Aizoaceae nativa de Namibia.', 10000.000, 'Media'),
(2, 1, 'Rosa de Alabastro', 'La Echeveria elegans o rosa de alabastro es una de las suculentas más bonitas y conocidas del mundo pertenenciente a la familia Crassulaceae', 9350.000, 'Media'),
(3, 1, 'Cola de borrego', 'Sedum morganianum es una especie de planta suculenta, nativa del sur de México.pertenece a la familia Crassulaceae', 9350.000, 'Media'),
(4, 3, 'Cactus Mammillaria elongata', 'Mammillaria elongata endémica del estado de Hidalgo, Guanajuato y estado de Querétaro en México.', 8500.000, 'Media'),
(5, 3, 'Cactus Erizo de Oro', 'Kroenleinia grusonii, llamado comúnmente cactus erizo. Es endémico del centro de México, desde Tamaulipas hasta el Estado de Hidalgo, y a pesar de ser uno de los cactus más populares', 8500.000, 'Media');
